...
(() => {
  ...
  String.prototype.simpleMaskStringCount = function(s1) {
  ...
  (function($) {
    ...
    $.fn.simpleMask.applyMask = function(p_object, p_key) {
      ...
      for (var i = 0; i < p_object.masks.length; i++) {
    ...
    $.fn.simpleMask.process = function(p_elem, p_options) {
      ...
      if (typeof p_options.mask == "string") {
        ...
        usemasks = p_options.mask.slice();
      }
      var originalLength = usemasks.length;
